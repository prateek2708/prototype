...
// Add new order
app.post('/order/:storeId/:orderId  ', (req, res) => {
    db.collection(storesCollection).doc(req.params.storeId)
...
//https://firestore-test-69e95.firebaseapp.com/store/v1/order/CoreA/filter/search?operatingRoom=101&limit=1